...
(function ($) {
    ...
    $.cleditor = {
        ...
        buttons: {
            ...
            "bullets,,insertunorderedlist,,<i class='fa fa-list-ol'></i>|" +
            "numbering,,insertorderedlist,,<i class='fa fa-list-ul'></i>|" +
            "outdent,,|" +
            "indent,,|" +
            ...
            "link,Insert Hyperlink,createlink,url,<i class='fa fa-link'></i>|" +
    ...
    BUTTON_CLASS = "cleditorButton btn",  // button divs inside group div
    ...
    $.each(buttons.init.split("|"), function (idx, button) {
        ...
        buttons[name] = {
            ...
            popupName: items[3],
            inner: items[4] === "" ? name[0].toUpperCase() : items[4],
        };
    });
    delete buttons.init;
